...
DATASET_PATH = "/raid/gurukul/vlm4bio/easy_data/Medium" 
...
for _, row in tqdm(df.iterrows(), total=len(df)):
    ...
    if "blip2" in model_name:
        ...
        # Apply the chat template (this adds tokens like <image>, etc., in the right format)
        ...
        response = processor.batch_decode(generate_ids[0][2:], skip_special_tokens=True)[0]  # [2:] skips special tokens
